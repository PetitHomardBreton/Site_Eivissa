...
export function addVisuelByRealisation(req, res) {
    ...
    const nomRealisation = req.params.nomRealisation;
    res.render('createVisuelByRealisation', { title: 'Ajout d\'un visuel à la réalisation :'+ nomRealisation, nomRealisation : nomRealisation, realisationId : realisationId ,action: "/realisations/" + realisationId + "/visuels/add", pageTitle: 'createVisuelByRealisation' });
};
